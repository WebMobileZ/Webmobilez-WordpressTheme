<?php 
  ...
  /* Template Name: Web Development staging
    */
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 pr_50">
                        <div class="faq_tab">
                            <h4 class="f_p t_color3 f_600 f_size_22 mb_40"> Java Topics</h4>
                            ...
                            <div class="tab-pane fade <?= $active ?>" id="<?= $subtitle ?>" role="tabpanel" aria-labelledby="<?= $subtitle ?>-tab">
                                ...
                                <div id="accordion<?= $cat->term_id ?>">
                                    <?php 
                                                                      ...
                                                                      $args = array('post_type' => 'javacourseassign','posts_per_page' => -1 ,'order'   => 'ASC',
                                        'tax_query' => array(
                                            array(
                                                'taxonomy' => 'assigntype',
                                                'field' => 'slug',
