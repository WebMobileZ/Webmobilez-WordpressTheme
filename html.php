...
<section class="faq_area bg_color sec_pad">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3 col-sm-3 pr_50">
                        <div class="faq_tab">
                            <h4 class="f_p t_color3 f_600  mb_40">HTML Course</h4>
                            ...
                            <div class="tab-pane fade <?= $active ?>" id="<?= $subtitle ?>" role="tabpanel" aria-labelledby="<?= $subtitle ?>-tab">
                                ...
                                <div id="accordion<?= $cat->term_id ?>">
                                    <?php 
                                                                      ...
                                                                      $args = array('post_type' => 'htmlmaterial','posts_per_page' => -1 ,'order'   => 'ASC',
                                        'tax_query' => array(
                                            array(
                                                'taxonomy' => 'htmltype',
                                                'field' => 'slug',
