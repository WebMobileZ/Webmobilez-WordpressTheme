...
<section class="breadcrumb_area">
    ...
    <div class="container">
        <div class="breadcrumb_content text-center">
            <h1 class="f_p f_700  w_color l_height50 mb_20"> Signin / Signup <span class="t_color3">WebMobileZ</span>
            </h1>
		...
		if( $email == "" || $password1 == "" || $username == "" || $first_name == "" || $last_name == "") {
			...
			if( is_wp_error($user_id) ) {
				...
				$success = 'You\'re successfully register';
				 wp_redirect(home_url('topics-java-full-stack') ); exit;
			}
                    ...
                    <ul class="nav nav-tabs develor_tab mb-30" id="myTab2" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active show" id="ruby-tab" data-toggle="tab" href="#ruby" role="tab"
                                aria-controls="ruby" aria-selected="true"  > Sign In </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="curl-tab" data-toggle="tab" href="#curl" role="tab"
                                aria-controls="curl" aria-selected="false"  >  Sign Up</a>
                        </li>
                    </ul>
                                ...
                                <div class="container">
                                    <div class="sign_info">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="login_info">
													<form name="loginform"  action="<?php echo get_page_link(1707) ?>"   id="registerform" class="login-form sign-in-form"  method="post">
                                                   <div class="row">												   
