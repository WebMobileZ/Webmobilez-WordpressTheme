...
<title>WebmobileZ 100% Training, Development, placement</title>
<meta name="title" content="WebmobileZ 100% Training, Development, placement">
<meta name="description" content="42 days JAVA FullStack Training In-person in Michigan & Online WebmobileZ Training & Placement in Michigan, We provide software consulting, development, support, maintenance and training services in USA. We successfully Delivered Multiple Produts in USA">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 pr_50">
                        <div class="faq_tab">
                            <h4 class="f_p t_color3 f_600 f_size_22 mb_40">Course Content & Schedule</h4>
                    ...
                    <div class="col-lg-7">
                        <div class="tab-content faq_content" id="myTabContent">
                            ...
                            <div class="tab-pane fade <?= $active ?>" id="<?= $subtitle ?>" role="tabpanel" aria-labelledby="<?= $subtitle ?>-tab">
                                <h3 class="f_p f_size_22 f_500 t_color3 mb_20"><?= $cat->name ?> <?php /*echo get_field('duration', $cat->taxonomy.'_'.$cat->term_id); */ ?>  </h3>
                                <div id="accordion<?= $cat->term_id ?>">
                                    <?php 


                                                                      $args = array('post_type' => 'topics','posts_per_page' => -1 ,'order'   => 'ASC',
                                        'tax_query' => array(
                                            array(
                                                'taxonomy' => 'topictype',
                                                'field' => 'slug',
                            ...
                            <div class="tab-pane fade <?= $active ?>" id="<?= $subtitle ?>" role="tabpanel" aria-labelledby="<?= $subtitle ?>-tab">
                                ...
                                <div id="accordion<?= $j ?>">
                                    <?php 
                                                                      ...
                                                                      $args = array('post_type' => 'topics','order'   => 'ASC',
                                        'tax_query' => array(
                                            array(
                                                'taxonomy' => 'topictype',
                                                'field' => 'slug',
        ...
        <section class="s_pricing_area sec_pad">
            <div class="container custom_container">
                <div class="sec_title text-center mb_70">
                    <h2 class="f_p f_size_30 l_height50 f_600 t_color3">A project based approach to crack your next awesome job</h2>
                ...
                <div class="row mb_30">
                    ...
                    <!--      <div class="strikeprice f_size_40 f_p f_700"> <strike>$998.00</strike><sub class="f_400 f_size_16">/ 10 weeks</sub></div> -->
                            <div class="price f_size_40 f_p f_700">$999.00<sub class="f_400 f_size_16">/ 42 days</sub></div>
                            <!-- <a href="#" data-target=".bd-example-modal-lg" data-toggle="modal" class="price_btn btn_hover mt_30">Make a payment through PayPal</a> -->
							<?php $price=999; echo do_shortcode('[wp_paypal button="buynow" class="paypal-button" name="Webmobilez" amount="999.00" button_image="https://webmobilez.com/wp-content/uploads/2020/02/malepayment.png"]'); ?>
                        </div>
                    </div>
	 ...
	 <div class="modal fade bd-request-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        ...
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">   
                        <h2>Make a payment through PayPal</h2>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                        </div>
                        <div class="modal-body">        
                           <?php echo do_shortcode('[contact-form-7 id="925" title="Make Payment"]'); ?>
							 <div class="paypal">
								 <?php $price=999; echo do_shortcode('[wp_paypal button="buynow" class="paypal-button" name="Webmobilez" amount="999.00"]'); ?>
							</div>
                        </div>
						 <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
