<?php 
  ...
  /* Template Name: Javascript Material
    */
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3 col-sm-3">
                        <div class="faq_tab">
                            <h4 class="f_p t_color3 f_600 mb_40">Javascript & jQuery Course</h4>
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
								 
								
								<?php 
			 $args = array(
                                               'taxonomy' => 'javascripttype',
                            ...
                            <div class="tab-pane fade <?= $active ?>" id="<?= $subtitle ?>" role="tabpanel" aria-labelledby="<?= $subtitle ?>-tab">
                                ...
                                <div id="accordion<?= $cat->term_id ?>">
                                    <?php 
                                                                      ...
                                                                      $args = array('post_type' => 'javascriptmaterial','posts_per_page' => -1 ,'order'   => 'ASC',
                                        'tax_query' => array(
                                            array(
                                                'taxonomy' => 'javascripttype',
                                                'field' => 'slug',
