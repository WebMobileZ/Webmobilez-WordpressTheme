...
<section class="faq_area bg_color sec_pad">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3 col-sm-3">
                        <div class="faq_tab">
                            <h4 class="f_p t_color3 f_600  mb_40"> Java Topics</h4>
    ...
    foreach ( $cats as $post ) :
      $string = strtolower(preg_replace('/\s+/', '', $post->name));
						...
						?>
						 <li class="nav-item">
                                    <a class="nav-link"   href="https://webmobilez.com/java-assignments/" role="tab" target="_blank" style="font-size:15px" aria-selected="true">Java Assignments</a></li>
                            ...
                            <div class="tab-pane fade <?= $active ?>" id="<?= $subtitle ?>" role="tabpanel" aria-labelledby="<?= $subtitle ?>-tab">
                                ...
                                <div id="accordion<?= $cat->term_id ?>">
                                    <?php 
                                                                      ...
                                                                      $args = array('post_type' => 'corejavacourse','posts_per_page' => -1 ,'order'   => 'ASC',
                                        'tax_query' => array(
                                            array(
                                                'taxonomy' => 'corejavatype',
                                                'field' => 'slug',
