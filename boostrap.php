<?php 
  ...
  /* Template Name: Boostrap Material
    */
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 pr_50">
                        <div class="faq_tab">
                            <h4 class="f_p t_color3 f_600 f_size_22 mb_40">Bootstrap Course</h4>
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
								 
								
								<?php 
			 $args = array(
                                               'taxonomy' => 'boostraptype',
                            ...
                            <div class="tab-pane fade <?= $active ?>" id="<?= $subtitle ?>" role="tabpanel" aria-labelledby="<?= $subtitle ?>-tab">
                                ...
                                <div id="accordion<?= $cat->term_id ?>">
                                    <?php 
                                                                      ...
                                                                      $args = array('post_type' => 'boostrapmaterial','posts_per_page' => -1 ,'order'   => 'ASC',
                                        'tax_query' => array(
                                            array(
                                                'taxonomy' => 'boostraptype',
                                                'field' => 'slug',
